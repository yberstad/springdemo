...
SET @product_id_2 = 2;
SET @product_id_3 = 3;
SET @product_number_1 = 'ABC1';
SET @product_number_2 = 'ABC2';
SET @product_number_3 = 'ABC3';
...
/*ORDER #1 */
SET @order_1_id = 1;
INSERT INTO orders(order_id, account_fk, total) VALUES (@order_1_id, 2, 11100.0);
...
/*ORDER #2 */
SET @order_2_id = 2;
INSERT INTO orders(order_id, account_fk, total) VALUES (2, 2, 1110.0);
INSERT INTO order_item(order_item_id, order_fk, product_number, product_name, count, total) VALUES (4, @order_1_id, @product_number_1, @product_name_1, 1, 100.0);
INSERT INTO order_item(order_item_id, order_fk, product_number, product_name, count, total) VALUES (5, @order_1_id, @product_number_2, @product_name_2, 1, 1000.0);
INSERT INTO order_item(order_item_id, order_fk, product_number, product_name, count, total) VALUES (6, @order_1_id, @product_number_3, @product_name_3, 1, 10000.0);
